...
const comparisons = [
  { feature: "Instant online pricing", pleasantcleanings: true, others: false },
  { feature: "Background-checked cleaners", pleasantcleanings: true, others: "warn" },
  { feature: "Satisfaction guarantee", pleasantcleanings: true, others: false },
  { feature: "Eco-friendly products", pleasantcleanings: true, others: false },
  { feature: "Online booking & reminders", pleasantcleanings: true, others: false },
];
  ...
  return (
    <div className="max-w-xl mx-auto mt-10">
      <h3 className="font-display text-xl font-semibold text-foreground text-center mb-6">
        Pleasant Cleanings vs. Other Services
      </h3>
      <div className="bg-card rounded-xl border border-border overflow-hidden shadow-soft">
        ...
        <div className="grid grid-cols-3 bg-muted px-4 py-3 text-sm font-semibold">
          ...
          <span className="text-center text-primary">Pleasant Cleanings</span>
