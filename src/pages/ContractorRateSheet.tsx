      ...
      <main className="container mx-auto px-4 py-12 print:py-4">
        ...
        <div className="max-w-3xl mx-auto bg-card border border-border rounded-lg p-8 print:border-0 print:shadow-none print:p-0">
          ...
          <div className="text-center border-b border-border pb-6 mb-8">
            <h1 className="font-display text-4xl font-bold text-primary mb-2">Pleasant Cleanings</h1>
            <p className="text-lg text-muted-foreground">Professional Cleaning Services</p>
            <div className="flex justify-center gap-6 mt-4 text-sm">
              <a href="tel:7867967445" className="flex items-center gap-1 text-foreground hover:text-primary">
                <Phone className="h-4 w-4" />
                (786) 796-7445
              </a>
              <a href="mailto:support@pleasantcleanings.com" className="flex items-center gap-1 text-foreground hover:text-primary">
          ...
          <section className="mb-8">
            ...
            <p className="text-sm text-muted-foreground">
              <strong>Broward County</strong> • <strong>Palm Beach County</strong> • <strong>Broward County</strong>
            </p>
          </section>
          ...
          <div className="text-center border-t border-border pt-6">
            ...
            <div className="flex justify-center gap-4">
              <a href="tel:7867967445" className="inline-flex items-center gap-2 bg-primary text-primary-foreground px-6 py-2 rounded-lg font-medium print:bg-transparent print:text-primary print:border print:border-primary">
                <Phone className="h-4 w-4" />
                (786) 796-7445
              </a>
            </div>
            <p className="text-xs text-muted-foreground mt-6">
              pleasantcleanings.com • Serving South Florida Since 2024
            </p>
          </div>
        </div>
      </main>
