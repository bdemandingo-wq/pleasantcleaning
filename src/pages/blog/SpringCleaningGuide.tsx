...
const SpringCleaningGuide = () => {
  return (
    <>
      <SEOSchema
        pageTitle="Spring Cleaning Guide for South Florida Homes | Pleasant Cleanings"
        ...
        canonicalUrl="https://pleasantcleanings.com/blog/spring-cleaning-guide-south-florida"
        pageType="blog"
            ...
            <div className="prose prose-lg max-w-none">
              ...
              <div className="bg-primary/10 rounded-xl p-6 mt-8">
                <h3 className="font-display text-xl font-bold text-foreground mb-3">
                  Let Pleasant Cleanings Handle Your Spring Cleaning
                </h3>
                <p className="text-muted-foreground mb-4">
