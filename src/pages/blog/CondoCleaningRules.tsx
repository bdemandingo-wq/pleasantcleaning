...
const CondoCleaningRules = () => {
  return (
    <>
      <SEOSchema
        pageTitle="Condo Cleaning Rules & Tips for South Florida | Pleasant Cleanings"
        pageDescription="Navigate HOA rules and building regulations while keeping your South Florida condo spotless."
        canonicalUrl="https://pleasantcleanings.com/blog/condo-cleaning-rules-south-florida"
        pageType="blog"
            ...
            <div className="prose prose-lg max-w-none">
              ...
              <div className="bg-primary/10 rounded-xl p-6 mt-8">
                <h3 className="font-display text-xl font-bold text-foreground mb-3">
                  Pleasant Cleanings Knows Condo Cleaning
                </h3>
