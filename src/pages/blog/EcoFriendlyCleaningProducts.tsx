...
const EcoFriendlyCleaningProducts = () => {
  return (
    <>
      <SEOSchema
        pageTitle="Best Eco-Friendly Cleaning Products for Florida Homes | Pleasant Cleanings"
        ...
        canonicalUrl="https://pleasantcleanings.com/blog/eco-friendly-cleaning-products"
        pageType="blog"
            ...
            <div className="prose prose-lg max-w-none">
              ...
              <div className="bg-primary/10 rounded-xl p-6 mt-8">
                <h3 className="font-display text-xl font-bold text-foreground mb-3">
                  Pleasant Cleanings Uses Eco-Friendly Products
                </h3>
