-- =====================================================
-- Pleasant Cleanings Admin Dashboard: 8 feature tables + site_content
...
INSERT INTO public.service_areas (slug, name, state, travel_fee, tier, sort_order) VALUES
  ('pembroke-pines-cleaning', 'Pembroke Pines', 'FL', 0, 'standard', 1),
  ('miramar-cleaning', 'Miramar', 'FL', 0, 'standard', 2),
  ('davie-cleaning', 'Davie', 'FL', 0, 'standard', 3),
  ('sunrise-cleaning', 'Sunrise', 'FL', 0, 'standard', 4),
  ('coral-springs-cleaning', 'Coral Springs', 'FL', 0, 'standard', 5),
  ('boca-raton-cleaning', 'Boca Raton', 'FL', 0, 'premium', 6),
  ('aventura-cleaning', 'Aventura', 'FL', 0, 'premium', 7),
  ('miami-beach-cleaning', 'Miami Beach', 'FL', 0, 'premium', 8),
  ('coral-gables-cleaning', 'Coral Gables', 'FL', 0, 'premium', 9),
  ('coconut-grove-cleaning', 'Coconut Grove', 'FL', 0, 'premium', 10),
  ('doral-cleaning', 'Doral', 'FL', 0, 'standard', 11),
  ('homestead-cleaning', 'Homestead', 'FL', 0, 'standard', 12)
